...
const STOCKS = [
  ...
  { symbol: "GARAN", verified: false, name: "Garanti BBVA", sector: "Bankacılık", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "",
  ...
  { symbol: "AKBNK", verified: false, name: "Akbank", sector: "Bankacılık", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "",
  ...
  { symbol: "YKBNK", verified: false, name: "Yapı Kredi", sector: "Bankacılık", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "",
  ...
  { symbol: "HALKB", verified: false, name: "Halkbank", sector: "Bankacılık", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: false, note: "Kamu bankası, temettü politikası değişken",
  ...
  { symbol: "VAKBN", verified: false, name: "VakıfBank", sector: "Bankacılık", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: false, note: "Kamu bankası, temettü politikası değişken",
  ...
  { symbol: "SAHOL", verified: false, name: "Sabancı Holding", sector: "Holding", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "",
  ...
  { symbol: "DOHOL", verified: false, name: "Doğan Holding", sector: "Holding", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: false, note: "Kâr olsa da her zaman dağıtmayabiliyor, temettü geçmişi tutarsız",
  ...
  { symbol: "PETKM", verified: false, name: "Petkim", sector: "Enerji/Petrokimya", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: false, note: "Marj baskısı dönemlerinde temettü düşebilir",
  ...
  { symbol: "TTKOM", verified: false, name: "Türk Telekom", sector: "Telekom", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: false, policyConsistent: true, note: "Yüksek borç yükü izlenmeli",
  ...
  { symbol: "EKGYO", verified: false, name: "Emlak Konut GYO", sector: "GYO", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "Konut piyasası döngüsüne duyarlı",
  ...
  { symbol: "ISGYO", verified: false, name: "İş GYO", sector: "GYO", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "",
  ...
  { symbol: "HLGYO", verified: false, name: "Halk GYO", sector: "GYO", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "",
  ...
  { symbol: "ULKER", verified: false, name: "Ülker Bisküvi", sector: "Gıda/Tüketim", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: false, policyConsistent: true, note: "Büyüme odaklı, düşük verim",
  ...
  { symbol: "CCOLA", verified: false, name: "Coca-Cola İçecek", sector: "Gıda/Tüketim", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: false, policyConsistent: true, note: "",
  ...
  { symbol: "BANVT", verified: false, name: "Banvit", sector: "Gıda/Tüketim", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: false, policyConsistent: true, note: "",
  ...
  { symbol: "FROTO", verified: false, name: "Ford Otosan", sector: "Sanayi/Otomotiv", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "İhracat ağırlıklı, kur avantajı",
  ...
  { symbol: "ARCLK", verified: false, name: "Arçelik", sector: "Sanayi/Otomotiv", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "Beyaz eşya, Avrupa talebine duyarlı",
  ...
  { symbol: "AGESA", verified: false, name: "AgeSA Hayat ve Emeklilik", sector: "Sigorta", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: false, policyConsistent: true, note: "",
  ...
  { symbol: "AKCNS", verified: false, name: "Akçansa", sector: "Çimento", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "İnşaat sektörü döngüsüne duyarlı",
  ...
  { symbol: "THYAO", verified: false, name: "Türk Hava Yolları", sector: "Ulaştırma", yieldPct: null, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "Yüksek operasyonel kaldıraç, yakıt fiyatı ve kur riskine duyarlı",
