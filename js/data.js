 ...
 * NOT: verified: true olan hisselerin yieldPct/payoutPct/debtToEquity/peRatio/
 * pbRatio/dividendYears değerleri web araştırmasıyla doğrulanmış GERÇEK verilerdir
 * (kaynak çelişkileri varsa "note" alanında açıklanmıştır). verified: false olan
 * hisselerde bu alanlar kasıtlı olarak null bırakılmıştır — uydurma sayı YOKTUR;
 * panel bunları "–" gösterir ve kriterlere göre asla "Uygun" işaretlemez
 * ("Doğrulanmamış" rozeti). Bir hisseyi araştırıp gerçek veri eklerken
 * verified: true yapmayı unutmayın.
...
const STOCKS = [
  ...
  { symbol: "GARAN", verified: true, name: "Garanti BBVA", sector: "Bankacılık", yieldPct: 3.15, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "Verim %3.15 ile hedef bandın altında. Payout/borç-özkaynak/F-K/PD-DD için güvenilir sayısal veri bulunamadı, null bırakıldı. 2026 için brüt 5.27 TL/net 4.48 TL temettü onaylandı (7 Nisan 2026).",
  ...
  { symbol: "AKBNK", verified: true, name: "Akbank", sector: "Bankacılık", yieldPct: 3.4, payoutPct: 18.27, debtToEquity: null, dividendYears: 6, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "1997-2018 kesintisiz, 2019-2020 kesinti (banka sektörü geneli), sonrasında yeniden başladı (~2021, tahmini) -> ~6 yıl. Banka olduğu için borç/özkaynak anlamlı değil, null. Verim %3.4 ile hedef bandın altında.",
  ...
  { symbol: "YKBNK", verified: true, name: "Yapı Kredi", sector: "Bankacılık", yieldPct: 3.94, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "Payout oranı ve kesintisiz temettü geçmişi için güvenilir veri bulunamadı, null bırakıldı. Verim %3.94 ile hedef bandın altında.",
  ...
  { symbol: "HALKB", verified: true, name: "Halkbank", sector: "Bankacılık", yieldPct: 0, payoutPct: 0, debtToEquity: null, dividendYears: 0, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: false, note: "2018'den beri temettü dağıtmıyor, 2026 için de dağıtılmayacağı KAP'a bildirildi (12 Mart 2026). Kamu bankası, siyasi kararlara bağlı.",
  ...
  { symbol: "VAKBN", verified: true, name: "VakıfBank", sector: "Bankacılık", yieldPct: 0, payoutPct: null, debtToEquity: null, dividendYears: 0, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: false, note: "2018'den beri (8 yıldır) nakit temettü dağıtmıyor; bazı raporlar dağıtımın 2027 sonrasına ertelendiğini belirtiyor. Kamu bankası.",
  ...
  { symbol: "SAHOL", verified: true, name: "Sabancı Holding", sector: "Holding", yieldPct: 3.08, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "Temettü verimi kaynağa göre %1.59-%3.08 arası, TTM olan %3.08 kullanıldı. Payout oranı yüzde olarak bulunamadı (sadece net borç/FAVÖK 1.7x verildi, klasik borç/özkaynak değil), null bırakıldı.",
  ...
  { symbol: "DOHOL", verified: true, name: "Doğan Holding", sector: "Holding", yieldPct: 1.49, payoutPct: null, debtToEquity: null, dividendYears: 0, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: false, note: "Bir kaynağa göre son 6 yıldır düzenli dağıtıyordu, ama 2025 yılı için (dönem zararı nedeniyle) 2026'da temettü dağıtılMAYACAĞI duyuruldu -- seri kesintiye uğradı, tutarsızlığın somut kanıtı.",
  ...
  { symbol: "PETKM", verified: true, name: "Petkim", sector: "Enerji/Petrokimya", yieldPct: 0, payoutPct: 0, debtToEquity: null, dividendYears: 0, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: false, note: "2025 yılı net zararı nedeniyle 2026'da temettü dağıtılmayacak (Nisan 2026 duyurusu). Geçmiş yıllarda %2-6.74 arası değişken verimler görülmüş.",
  ...
  { symbol: "TTKOM", verified: true, name: "Türk Telekom", sector: "Telekom", yieldPct: null, payoutPct: null, debtToEquity: 0.45, dividendYears: null, peRatio: null, pbRatio: null, cyclical: false, policyConsistent: true, note: "2025 kârı için Mart/Nisan 2026'da temettü dağıtım kararı alındı ve uygulandı, ama verim/payout/kesintisiz yıl sayısı için net rakam bulunamadı. Borç/özkaynak ~0.45 net borç (119.4mlr)/özkaynak (265.3mlr) üzerinden hesaplandı (2026 2Ç) -- tahmini.",
  ...
  { symbol: "EKGYO", verified: true, name: "Emlak Konut GYO", sector: "GYO", yieldPct: 2.94, payoutPct: 37.94, debtToEquity: null, dividendYears: 5, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "Payout oranı için kaynaklar %37.94 ile %28.80 arasında çelişti, ilk rakam kullanıldı. Temettü geçmişi net verilmedi; '5 yıllık temettü büyüme oranı %81.75' verisi en az 5 yıllık bir seri olduğunu ima ediyor (tahmini). GYO statüsü nedeniyle stopaj yok.",
  ...
  { symbol: "ISGYO", verified: true, name: "İş GYO", sector: "GYO", yieldPct: 0.38, payoutPct: null, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "Payout oranı bir kaynakta -%19 gibi anormal/negatif çıktı (muhtemelen zarar dönemi), güvenilir bulunmadı, null bırakıldı. Temettü verimi çok düşük (%0.38). 2010'dan beri dağıttığına dair işaret var ama kesintisiz olup olmadığı doğrulanamadı.",
  ...
  { symbol: "HLGYO", verified: true, name: "Halk GYO", sector: "GYO", yieldPct: 23.98, payoutPct: 25.41, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: false, note: "Verimde 2024'ten (%0.16) 2025'e (%23.98) olağandışı bir sıçrama var -- muhtemelen tek seferlik büyük bir dağıtım veya %56.25 bedelsiz sermaye artırımıyla ilişkili bir anomali. %23.98 hedef bandın çok üzerinde ve sürdürülebilir görünmüyor, dikkatli yaklaşın.",
  ...
  { symbol: "ULKER", verified: true, name: "Ülker Bisküvi", sector: "Gıda/Tüketim", yieldPct: 6.9, payoutPct: null, debtToEquity: 0.83, dividendYears: null, peRatio: null, pbRatio: null, cyclical: false, policyConsistent: true, note: "Verim kaynağa göre %4.4 ile %6.90 (TTM) arası değişti, TTM olan kullanıldı. Borç/özkaynak ~0.83 net borç (42.1mlr)/özkaynak (51.0mlr) üzerinden hesaplandı (2026 2Ç).",
  ...
  { symbol: "CCOLA", verified: true, name: "Coca-Cola İçecek", sector: "Gıda/Tüketim", yieldPct: 2.26, payoutPct: 27.84, debtToEquity: 0.33, dividendYears: null, peRatio: null, pbRatio: null, cyclical: false, policyConsistent: false, note: "Verim kaynağa göre %1.32-%2.26 arası, daha güncel olan %2.26 kullanıldı. Borç/özkaynak ~0.33 net borç (29.9mlr)/özkaynak (91.6mlr) üzerinden hesaplandı. Temettü geçmişi 'son 10 yılda oynak ama artan' olarak tanımlandı, net kesintisiz yıl sayısı bulunamadı -- bu oynaklık nedeniyle tutarlı sayılmadı.",
  ...
  { symbol: "BANVT", verified: true, name: "Banvit", sector: "Gıda/Tüketim", yieldPct: 0, payoutPct: 0, debtToEquity: null, dividendYears: 0, peRatio: null, pbRatio: null, cyclical: false, policyConsistent: false, note: "2022-2025 arası temettü dağıtılmamış, 2026 genel kurulunda da dağıtılmaması kararlaştırıldı. Uzun süreli bir kesinti içinde.",
  ...
  { symbol: "FROTO", verified: true, name: "Ford Otosan", sector: "Sanayi/Otomotiv", yieldPct: 12.08, payoutPct: null, debtToEquity: 1.7, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "TTM verim %12.08 ile hedef bandın (%4-7) çok üzerinde -- bu genelde sürdürülemez bir sinyal (fiyat düşüşü veya özel/tek seferlik dağıtım olabilir); 2026 için ayrı bir tahmin %7.9 veriyor, kaynaklar tutarsız. Borç/özkaynak ~1.70 (bilanço yapısı yüzdelerinden hesaplandı: %63 yükümlülük/%37 özkaynak) -- yüksek.",
  ...
  { symbol: "ARCLK", verified: true, name: "Arçelik", sector: "Sanayi/Otomotiv", yieldPct: null, payoutPct: 51.3, debtToEquity: 6.1, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: false, note: "Arama sonuçları güncelliği şüpheli veriler döndürdü (en son ödeme 'Eylül 2023' olarak gösterildi, 2026 güncel değil), bu yüzden güncel verim null bırakıldı. 2019-2020 kesintisi doğrulandı. Borç/özkaynak ~6.1 (özkaynak toplam aktifin sadece %14'ü) -- çok yüksek kaldıraç, ciddi bir uyarı işareti. Payout oranı son 5 yıl ortalaması %51.3 olarak bulundu.",
  ...
  { symbol: "AGESA", verified: true, name: "AgeSA Hayat ve Emeklilik", sector: "Sigorta", yieldPct: 2.85, payoutPct: 69.44, debtToEquity: null, dividendYears: 5, peRatio: null, pbRatio: null, cyclical: false, policyConsistent: true, note: "Payout brüt %69.44 / net %59.03 olarak verildi, brüt kullanıldı. Temettü geçmişi net verilmedi; '5 yıllık temettü büyüme oranı %44.27' verisi en az 5 yıllık bir seri olduğunu ima ediyor (tahmini).",
  ...
  { symbol: "AKCNS", verified: true, name: "Akçansa", sector: "Çimento", yieldPct: 0.88, payoutPct: null, debtToEquity: 0.18, dividendYears: 29, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "1997'den beri 29 yıldır aralıksız temettü dağıtıyor -- havuzdaki en uzun kesintisiz geçmişlerden biri, kaynak bunu açıkça doğruladı. Ancak güncel verim sadece %0.88 ile hedef bandın (%4-7) çok altında. Borç/özkaynak ~0.18 (4.36mlr borç/24.01mlr özkaynak) -- çok düşük, sağlıklı.",
  ...
  { symbol: "THYAO", verified: true, name: "Türk Hava Yolları", sector: "Ulaştırma", yieldPct: 2.41, payoutPct: 8.38, debtToEquity: null, dividendYears: null, peRatio: null, pbRatio: null, cyclical: true, policyConsistent: true, note: "Veriler kısmen çelişkili: TTM verim %2.41, ama '2025 yılı verim/payout %0.00' diyen bir metrik de var (muhtemelen farklı bir raporlama dönemine ait, netleştirilemedi) -- 2024 payout oranı (%8.38) en güvenilir bulunan rakam olarak kullanıldı. Kesintisiz temettü yıl sayısı için net veri bulunamadı, null bırakıldı.",
