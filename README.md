...
1. Bir Anthropic API anahtarı alın (https://console.anthropic.com) ve
   hesabınızda yeterli kredi/bakiye olduğundan emin olun (API kullanımı,
   Claude.ai aboneliğinden ayrı bir bakiye gerektirir — bkz. Plans & Billing).
